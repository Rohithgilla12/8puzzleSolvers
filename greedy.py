...
def GREEDYsearch(initialstate,goalstate):
	time1=time.clock()
	if initialstate == goalstate :
		print("*Initial State is the Goal State*")
		return	("GREEDYsearch",0,"-",False)
	...
	iteration = 1
	while len(toVisit)!=0 :
		if (time.clock()-time1 )>30 :
			with open("output.txt",'a') as outfile :				
				out2 ="\n" + "GREEDY Search Technique : "+"\n"+"nodes explored - " + str(iteration) +"\n"
				outfile.write(out2)
			return ("GREEDYsearch",str(iteration),"-",True)

		print("GREEDY search technique running .......")
		...
		if currentState == goalstate :
			...
			# 	out2 =out1 +"\n" + "GREEDY Search Technique : "+"\n"+"nodes explored - " + str(iteration) +"\n"
			# 	outfile.write(out2)
			return ("GREEDYsearch",str(iteration),"-",False)
		# print("2")
...
if __name__ == '__main__':
		...
		print("goalstate : ")
		printlist(goalstate)
		GREEDYsearch(initialstate,goalstate)
